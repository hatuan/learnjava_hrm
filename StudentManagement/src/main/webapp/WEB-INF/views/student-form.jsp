...
<body>
    <div class="container">
        ...
        <div>
            ...
            <form:form action="${pageContext.request.contextPath}/student/${course.id}/save-student"
            ...
            <div style=""></div>
            <p>
                <a href="${pageContext.request.contextPath}/student/${course.id}/list" class="btn btn-dark">Back to List</a>
            </p>
