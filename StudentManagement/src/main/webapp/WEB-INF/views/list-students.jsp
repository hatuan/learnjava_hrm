...
<body>
    <div class="container">
            ...
            <div>
                ...
                <table class="table">
                    ...
                    <c:forEach var="tempStudent" items="${students}">
                        ...
                        <c:url var="updateLink" value="/student/${course.id}/showFormForUpdate">
        ...
        <p>
            <a href="${pageContext.request.contextPath}/course/list" class="btn btn-dark">Back to list course</a>
        </p>
    </div>
</body>
