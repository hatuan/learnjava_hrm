...
<body>
    <div class="container">
        ...
        <div>
            <h3>Save Course</h3>
            <form:form action="${pageContext.request.contextPath}/course/save-course" modelAttribute="course"
                method="POST">
            ...
            <div style=""></div>
            <p>
                <a href="${pageContext.request.contextPath}/course/list" class="btn btn-dark">Back to List</a>
            </p>
        </div>
    </div>
</body>
